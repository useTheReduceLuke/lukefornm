...
export const Home = () => {
  return (
    <div
      className={
        "flex flex-1 flex-col overflow-x-hidden items-start w-full pt-[112px] lg:pt-[96px]"
      }
    >
      <ProgressiveImage
        src={Abq2Md}
        placeholderSrc={Abq2Sm}
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div className="text-4xl md:text-6xl border-b-2 border-b-black/80">
                {" "}
                Luke Jungmann
              </div>
              ...
              <b>
                New Mexico House of Representatives District 60 in Rio Rancho
              </b>
            </p>
            <img
              className={
      ...
      <div
        className={
          "relative min-h-max flex flex-col items-center md:py-32 py-16 align-bottom w-full bg-blue-50"
        }
      >
        <div className="text-5xl pb-16 md:pb-0 md:text-6xl text-center">
      ...
      >
        <div className="text-5xl md:text-6xl text-center">Endorsements</div>
      </div>
      <Endorsements />
      <Information />
      <Footer />
